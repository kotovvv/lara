...
function TranslateInnerRo(str)
{
    try
    {
        ...
        str = str.replace("Credit", "Credit");
            ...
            if (str === "Ready.") return "Gata.";
            if (str === "Waiting") return "Aşteptare";
...
function TranslateInnerFr(str)
{
    try
    {
        ...
        str = str.replace("Credit", "Solde");
            ...
            if (str === "Save my settings on this computer locally (including password!)") return "Sauver les données localement";
...
//file modified by MTranslate at 10/20/2022 13:59:59 changed: 1
