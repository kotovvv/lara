...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    selectedProvider: function selectedProvider(newval) {
      this.users = [];
      this.related_user = [];
      var related_user = this.providers.find(function (p) {
        return p.id == newval;
      }).related_users_id;
