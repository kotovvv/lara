...
/* harmony import */ var _VIcon__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../VIcon */ "./node_modules/vuetify/lib/components/VIcon/VIcon.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vue__WEBPACK_IMPORTED_MODULE_2__.default.extend({
  ...
  render(h, {
    ...
    children.push(h(_VIcon__WEBPACK_IMPORTED_MODULE_6__.default, _mixins_colorable__WEBPACK_IMPORTED_MODULE_4__.default.options.methods.setTextColor(props.value && props.color, {
      props: {
    ...
    return h('div', (0,_util_mergeData__WEBPACK_IMPORTED_MODULE_7__.default)(data, {
      class: {
      ...
      on: {
        click: e => {
          ...
          if (data.on && data.on.input && !props.disabled) {
            (0,_util_helpers__WEBPACK_IMPORTED_MODULE_3__.wrapInArray)(data.on.input).forEach(f => f(!props.value));
          }
        }
      }
    }), [h('div', {
...
function filterFn(item, search, filter) {
  return header => {
    const value = (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getObjectValueByPath)(item, header.value);
...
function searchTableItems(items, search, headersWithCustomFilters, headersWithoutCustomFilters, customFilter) {
  ...
  return items.filter(item => {
    ...
    const matchesColumnFilters = headersWithCustomFilters.every(filterFn(item, search, _util_helpers__WEBPACK_IMPORTED_MODULE_13__.defaultFilter)); // Headers without custom filters are only filtered by the `search` property if it is defined.
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_util_mixins__WEBPACK_IMPORTED_MODULE_16__.default)(_VDataIterator__WEBPACK_IMPORTED_MODULE_2__.VDataIterator, _mixins_loadable__WEBPACK_IMPORTED_MODULE_11__.default).extend({
  name: 'v-data-table',
  ...
  computed: {
    ...
    sanitizedHeaderProps() {
      return (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.camelizeObjectKeys)(this.headerProps);
    },
  ...
  created() {
    ...
    breakingProps.forEach(([original, replacement]) => {
      if (this.$attrs.hasOwnProperty(original)) (0,_util_console__WEBPACK_IMPORTED_MODULE_14__.breaking)(original, replacement, this);
    });
  },
  ...
  methods: {
    ...
    genCaption(props) {
      ...
      return (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getSlot)(this, 'caption', props, true);
    },
    ...
    genHeaders(props) {
      ...
      const children = [(0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getSlot)(this, 'header', { ...data,
        isMobile: this.isMobile
      })];

      if (!this.hideDefaultHeader) {
        const scopedSlots = (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getPrefixedScopedSlots)('header.', this.$scopedSlots);
    ...
    genDefaultSimpleRow(item, index, classes = {}) {
      const scopedSlots = (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getPrefixedScopedSlots)('item.', this.$scopedSlots);
      ...
      return this.$createElement(this.isMobile ? _MobileRow__WEBPACK_IMPORTED_MODULE_10__.default : _Row__WEBPACK_IMPORTED_MODULE_6__.default, {
        key: (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getObjectValueByPath)(item, this.itemKey),
        class: (0,_util_mergeData__WEBPACK_IMPORTED_MODULE_15__.mergeClasses)({ ...classes,
          'v-data-table__selected': data.isSelected
        }, (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getPropertyFromItem)(item, this.itemClass)),
        props: {
          headers: this.computedHeaders,
    ...
    genBody(props) {
      ...
      return this.$createElement('tbody', [(0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getSlot)(this, 'body.prepend', data, true), this.genItems(props.items, props), (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getSlot)(this, 'body.append', data, true)]);
    },
    ...
    genFooters(props) {
      ...
      const children = [(0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getSlot)(this, 'footer', data, true)];

      if (!this.hideDefaultFooter) {
        children.push(this.$createElement(_VDataIterator__WEBPACK_IMPORTED_MODULE_2__.VDataFooter, { ...data,
          scopedSlots: (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getPrefixedScopedSlots)('footer.', this.$scopedSlots)
        }));
      }
    ...
    genDefaultScopedSlot(props) {
      ...
      return this.$createElement(_VSimpleTable__WEBPACK_IMPORTED_MODULE_9__.default, {
        props: simpleProps
      }, [this.proxySlot('top', (0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.getSlot)(this, 'top', { ...props,
        isMobile: this.isMobile
    ...
    return this.$createElement(_VData__WEBPACK_IMPORTED_MODULE_1__.VData, {
      ...
      on: {
        'update:options': (v, old) => {
          ...
          !(0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.deepEqual)(v, old) && this.$emit('update:options', v);
        },
        'update:page': v => this.$emit('update:page', v),
        'update:items-per-page': v => this.$emit('update:items-per-page', v),
        'update:sort-by': v => this.$emit('update:sort-by', v),
        ...
        'update:group-by': v => this.$emit('update:group-by', v),
        'update:group-desc': v => this.$emit('update:group-desc', v),
        pagination: (v, old) => !(0,_util_helpers__WEBPACK_IMPORTED_MODULE_13__.deepEqual)(v, old) && this.$emit('pagination', v),
        'current-items': v => {
          this.internalCurrentItems = v;
          this.$emit('current-items', v);
        },
...
/* harmony import */ var _mixins_dependent__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../mixins/dependent */ "./node_modules/vuetify/lib/mixins/dependent/index.js");
...
/* harmony import */ var _directives_click_outside__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../directives/click-outside */ "./node_modules/vuetify/lib/directives/click-outside/index.js");
...
const baseMixins = (0,_util_mixins__WEBPACK_IMPORTED_MODULE_12__.default)(_mixins_dependent__WEBPACK_IMPORTED_MODULE_13__.default, _mixins_delayable__WEBPACK_IMPORTED_MODULE_3__.default, _mixins_detachable__WEBPACK_IMPORTED_MODULE_4__.default, _mixins_menuable__WEBPACK_IMPORTED_MODULE_5__.default, _mixins_returnable__WEBPACK_IMPORTED_MODULE_6__.default, _mixins_roundable__WEBPACK_IMPORTED_MODULE_7__.default, _mixins_toggleable__WEBPACK_IMPORTED_MODULE_8__.default, _mixins_themeable__WEBPACK_IMPORTED_MODULE_14__.default);
/* @vue/component */

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (baseMixins.extend({
  name: 'v-menu',
  directives: {
    ClickOutside: _directives_click_outside__WEBPACK_IMPORTED_MODULE_15__.default,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_util_mixins__WEBPACK_IMPORTED_MODULE_7__.default)(_mixins_colorable__WEBPACK_IMPORTED_MODULE_5__.default, _mixins_themeable__WEBPACK_IMPORTED_MODULE_8__.default).extend({
  name: 'v-select-list',
  // https://github.com/vuejs/vue/issues/6872
  directives: {
